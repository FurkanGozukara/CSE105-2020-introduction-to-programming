    ...
    public static class helper_methods
    {
       ...
       public static string ComputeSha256Hash(this string rawData)
        ...
        public static void doLogin(string _srUserLoggedInName)
        {
            ...
            blUserLoggedIn = true;
            runningWindow.tabRegister.IsEnabled = false;
            runningWindow.tabLogin.IsEnabled = false;
            runningWindow.tabLoggedIn.IsSelected = true;
            runningWindow.tabLoggedIn.IsEnabled = true;
            runningWindow.lblLoggedInUserName.Content = "Logged User: "+ _srUserLoggedInName;
            runningWindow.displayMessage("You have successfully logged-in");

            runningWindow.tabLogout.Visibility = Visibility.Visible;
            runningWindow.tabLogout.IsEnabled = true;
        }

        public static void doLogOut()
        {
            srUserLoggedInName = "NA";
            blUserLoggedIn = false;
            runningWindow.tabRegister.IsEnabled = true;
            runningWindow.tabLogin.IsEnabled = true;
            runningWindow.tabLoggedIn.IsSelected = false;
            runningWindow.tabLoggedIn.IsEnabled = false;
            runningWindow.lblLoggedInUserName.Content = srUserLoggedInName;

            runningWindow.tabLogout.Visibility = Visibility.Hidden;
            runningWindow.tabLogout.IsEnabled = false;

            runningWindow.tabLogin.IsSelected = true;
        }
    }
}
